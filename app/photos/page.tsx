...
import { supabase, isUserAdmin, saveRotationsToSupabase, loadRotationsFromSupabase, saveMetadataToSupabase, loadMetadataFromSupabase, savePhotoRotation } from "@/lib/supabase";
...
export default function PhotosPage() {
  ...
  useEffect(() => {
    const initData = async () => {
      ...
      // Limpiar etiquetas genéricas de recuerdo familiar de los metadatos cargados en LocalStorage
      ...
      if (metadataJson) {
        try {
          ...
          console.error("Error al limpiar metadatos locales:", e);
        }
      }
    };
    initData();
